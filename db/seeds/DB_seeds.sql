...
INSERT INTO resources (user_id, number_of_likes, url, title, description, category, date) VALUES (1,3, 'https://jquery.com', 'Jquery', 'Jquery documentation', 'Computer Science','2021-09-10');
INSERT INTO resources (user_id, number_of_likes, url, title, description, category, date) VALUES (1, 2,'https://www.khanacademy.org/math', 'Math', 'Math article and exercises','Math', '2020-01-01');
